...
test('category balance is updated when transaction is created', function (): void {
...
test('category balance is updated when transaction is updated', function (): void {
...
test('category balance is updated when transaction is deleted', function (): void {
...
test('category balance is updated when transaction merchant is changed', function (): void {
    $transaction = Transaction::factory()->create([
        'account_id' => $this->account->id,
        'category_id' => $this->category->id,
        'merchant_id' => $this->merchant->id,
